                ...
                <div className="container-fluid">
                    ...
                    <div className="navbar-right">
                        ...
                        <div className="profile-dropdown">
                            <button onClick={handleProfileClick} className="nav-link profile-link">
                                ...
                                <div className="dropdown-menu">
                                    {isAuthenticated ? (
                                        <>
                                            ...
                                            {/* Common user links */}
                                            <button onClick={() => handleMenuItemClick('/profile')} className="dropdown-item">My Profile</button>

                                            {/* Organizer-specific links */}
                                            {hasRole('organizer') && (
                                                <>
                                                    <button onClick={() => handleMenuItemClick('/my-events')} className="dropdown-item">My Events</button>
                                                    <button onClick={() => handleMenuItemClick('/create-event')} className="dropdown-item">Create Event</button>
                                                    <button onClick={() => handleMenuItemClick('/event-analytics')} className="dropdown-item">Event Analytics</button>
                                                </>
                                            )}
                                            ...
                                            {hasRole('admin') && (
                                                <>
                                                    ...
                                                    <button onClick={() => handleMenuItemClick('/admin/users')} className="dropdown-item">User Management</button>
                                                    <button onClick={() => handleMenuItemClick('/admin/events')} className="dropdown-item">Event Management</button>
                                                </>
                                            )}
                                        ...
                                        <>
                                            <button onClick={handleOpenLoginModal} className="dropdown-item">Login</button>
                                            <div className="dropdown-divider"></div>
                                            <button onClick={handleOpenRegisterModal} className="dropdown-item">Sign Up</button>
                                        </>
                                    )}
                                </div>
                            )}
