                ...
                <div className="auth-modal">
                    ...
                    <form onSubmit={handleSubmit} className="auth-form">
                        ...
                        <div className="form-group form-check">
                            ...
                            <Link to="/forgot-password" className="float-end" onClick={closeModals}>Forgot Password?</Link>
                        </div>
                    ...
                    <div className="auth-links">
                        <p>Don't have an account? <button className="text-link" onClick={openRegisterModal}>Register</button></p>
                    </div>
                </div>
            </div>
        </div>
