    ...
    const getRoleIcon = (role) => {
        switch (role) {
            ...
            case 'organizer':
                return (
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M8 6V4C8 2.89543 8.89543 2 10 2H14C15.1046 2 16 2.89543 16 4V6M3 6H21M5 6V20C5 21.1046 5.89543 22 7 22H17C18.1046 22 19 21.1046 19 20V6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                        <path d="M12 12V16M9 12H15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                );
            case 'admin':
                return (
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M9 12L11 14L15 10M7 3.33782C8.47087 2.48697 10.1786 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12C2 10.1786 2.48697 8.47087 3.33782 7" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                );
            default:
                return null;
        ...
        <div className="modal-backdrop">
            <div className="modal-container">
                <div className="auth-modal">
                    ...
                    <p className="auth-subtitle">Join TicketsMarche to explore amazing events</p>
                            ...
                            <div className="role-selection-wrapper">
                                ...
                                >
                                    ...
                                    <div className="role-details">
                                        ...
                                        <div className="role-description">{getRoleDescription('user')}</div>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <div className="role-details">
                                        ...
                                        <div className="role-description">{getRoleDescription('organizer')}</div>
                                    </div>
                                </div>
                                ...
                                >
                                    ...
                                    <div className="role-details">
                                        ...
                                        <div className="role-description">{getRoleDescription('admin')}</div>
                                    </div>
                                </div>
                            </div>
                            <input 
                    ...
                    <div className="auth-links">
                        <p>Already have an account? <button className="text-link" onClick={openLoginModal}>Login</button></p>
                    </div>
                </div>
            </div>
        </div>
